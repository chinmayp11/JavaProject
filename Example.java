...
public class Example extends JFrame implements ActionListener
{
   ...
   // JButton addcrimeButton=new JButton("ADD CRIME");
    JButton viewCriminalbutton=new JButton("ViewCriminal");
    ...
    public void setLocationAndSize()
    {
        ...
        viewCriminalbutton.setBorder(javax.swing.BorderFactory.createEmptyBorder());
        ...
        viewCriminalbutton.setBackground(Color.CYAN);
    }
...

{
    ...
    else if (button.equals("ViewCriminal"));
    {
        new Jtable();
    }
...
//        deleteButton.addActionListener(this);
        ...
        viewCriminalbutton.addActionListener(this::actionPerformed);
    }
